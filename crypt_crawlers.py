...
def pick_up(item, chara_data, map_list, map_file):
    ...
    :param item: String containing the thing code.
    :param chara_data: Object containing information about the character.
    :param map_list: Matrix to be operated on.
...
def generate(chara_data, enemy_data, map_list, map_file, level, debug=False):
    ...
    :param debug: Boolean, is set to true if debug mode is active.
    """
...
def map_try(cart_x, cart_y, map_file):
    ...
    :param cart_x: An integer, the x cordinate of the test point
    :param cart_y: An integer, the y cordinate of the test point
    :param map_file: A matrix, the game map
    """
    free_coordinates = []
...
def uptry(cart_x, cart_y, sizex, sizey, map_list, tile_type=[["X"],["X."]]):
    ...
    :param cart_x: An integer, the x position of the test point.
    :param cart_y: An integer, the y position of the test point.
    :param sizex: An integer, the height of the room.
    :param sizey: An integer, the width of the room.
    :param map_list: A matrix, the game map.
    :param tile_type: A list, the martix items that are required for a
    new room
    """
